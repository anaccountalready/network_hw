...
int checkchecksum(PDU& recvpdu) {
	uint32_t tem = add(add(add(add(add(add(add(recvpdu.source_port, recvpdu.dest_port), recvpdu.ack), recvpdu.seq), recvpdu.flags), recvpdu.length),recvpdu.sourceip),recvpdu.destip);
	int i = 0;
